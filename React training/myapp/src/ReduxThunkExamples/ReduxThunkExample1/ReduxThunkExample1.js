...
class ReduxThunkExample1 extends Component {
    render () {
        return (
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onSaveResult: (result) => dispatch(ResultactionCreators.async_save_result(result)),
        onRemoveResult: (id) => dispatch(ResultactionCreators.remove_result(id))
    }
};

export default connect(mapStateToProps, mapDispatchToProps)(ReduxThunkExample1);